...
export default async function handler(req, res) {
  ...
  // Reusa las mismas VITE_SUPABASE_URL/VITE_SUPABASE_ANON_KEY que ya tiene
  // este proyecto -- el prefijo VITE_ solo controla qué se empaqueta en el
  // bundle del navegador, una función serverless puede leer cualquier env
  // var igual. Evita duplicar el mismo valor bajo dos nombres distintos.
